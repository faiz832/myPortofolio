...
const Contact = () => {
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact-container container grid" data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">risyad832@gmail.com</span>

              <a href="mailto:risyad832@gmail.com.com" className="contact-button">
                Contact me
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">089-533-597-6572</span>

              <a href="https://api.whatsapp.com/send?phone=62895335976572&text=Hello, more information!" className="contact-button">
                Contact me
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
              </a>
            </div>
